...
class NewFund(View):
    def dispatch_request(self):
        ...
        URL_TMP = 'http://fund.eastmoney.com/data/FundNewIssue.aspx?t={type}&sort=jzrgq,desc&y=&page=1,300&isbuy=1'
        ...
        for k,v in result.items():
            db_records.append({'name':k, 'count':v})

        #table = ItemTable(db_records)
